  ...
  <section class="home__bottom__section home__bottom__section__form">
    ...
    <ul class="content form">
      <li class="form__items">
        ...
        <p class="form__items__cells log__name">名稱</p>
      </li>
      <li class="form__items">
        <label class="form__items__title">樓層位置</label>
        <p class="form__items__cells log__floor">樓層</p>
      </li>
      <li class="form__items">
        <label class="form__items__title">查驗人員</label>
        <select class="form__items__cells log__inspector">
          <option>尚未查驗</option>
        </select>
      </li>
      <li class="form__items">
        <label class="form__items__title">隨行人員</label>
        <input class="form__items__cells log__accompany" type="text" placeholder="以半形逗號區隔"/>
      </li>
      <li class="form__items">
        <label class="form__items__title">查驗日期</label>
        <input class="form__items__cells log__date" type="date" placeholder="yyyy-mm-dd"/>
      </li>
      <li class="form__items">
        <label class="form__items__title">查驗類型</label>
        <select class="form__items__cells log__category">
      ...
      <li class="form__items">
        ...
        <select class="form__items__cells log__selfCheckState">
      ...
      <li class="form__items">
        ...
        <select class="form__items__cells log__status">
          <option value="符合">符合</option>
          <option value="不符合">不符合</option>
        </select>
      </li>
      <li class="form__items form__items__problem">
        ...
        <textarea class="form__items__cells log__problem"></textarea>
      </li>
      <li class="form__items">
